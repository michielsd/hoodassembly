...
#read 2017 from sql
pull2017 = """SELECT codering_3, gemiddeldinkomenperinkomensontvanger_65, k_20huishoudensmethoogsteinkomen_71, huishoudensmeteenlaaginkomen_72, totaaldiefstaluitwoningschuured_78, vernielingmisdrijftegenopenbareorde_79, geweldsenseksuelemisdrijven_80 FROM wijkbuurt201819"""
...
df['pctbijstand_207'] = round(100*df['personenpersoortuitkeringbijstand_74'] / df['aantalinwoners_5'], 1)  
...
df1['diefstal_213'] = np.nan
df1['vernieling_214'] = np.nan
df1['geweld_215'] = np.nan
