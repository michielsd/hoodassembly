...
# sql phrases
importschool = """SELECT brinnummer, instellingsnaam, straatnaam, huisnummer, postcode, plaatsnaam FROM middelschool WHERE bu_code is null"""
exportcode = """UPDATE middelschool SET lon = %s, lat = %s, gem_code = %s, wk_code = %s, bu_code = %s WHERE vestigingsnummer = %s"""
