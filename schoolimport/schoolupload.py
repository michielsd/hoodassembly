...
add_line = """INSERT INTO basisschool (Vestigingsnummer,  Vestigingsnaam,  Straatnaam,  Huisnummer,  Postcode,  Plaatsnaam,  Gemeentenaam,  Denominatie,  Telefoonnummer,  Internetadres) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"""
